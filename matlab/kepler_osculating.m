function [a, ecc_norm, incl, Omega, omega, E, M, f] = kepler_osculating(r, v, mu)
% KEPLER_OSCULATING - Compute Osculating Orbit Parameters.
%   
% INPUTS: 
...
%   M              Mean anomaly (ind degrees).
%   f              Natural anomaly (in degrees).
